...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="Freeway-v5",
...
if __name__ == "__main__":
    args = parse_args()
    run_name = f"{args.env_id}__{args.exp_name}__{int(time.time())}__{args.total_timesteps}"
    if args.track:
        import wandb
    ...
    #agent.save("./runs_seaquest_10/Training/PPO/models/")
    envs.close()
    writer.close()
